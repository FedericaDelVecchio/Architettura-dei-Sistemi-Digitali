...
set_property CLOCK_DEDICATED_ROUTE FALSE [get_nets insert_IBUF]
...
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { insert }]; #IO_L9N_T1_DQS_D13_14 Sch=btnd
