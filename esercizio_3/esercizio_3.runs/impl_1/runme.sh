...
HD_PWD='C:/VHDL/TESINA/esercizio_3 - Copia/esercizio_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log riconoscitore_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source riconoscitore_board.tcl -notrace
