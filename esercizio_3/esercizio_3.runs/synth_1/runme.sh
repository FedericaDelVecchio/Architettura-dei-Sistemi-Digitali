...
HD_PWD='C:/VHDL/TESINA/esercizio_3 - Copia/esercizio_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log riconoscitore_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source riconoscitore_board.tcl
