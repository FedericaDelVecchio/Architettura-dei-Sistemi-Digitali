...
HD_PWD='C:/VHDL/TESINA/esercizio_1/esercizio_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log interconnect_16_4_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source interconnect_16_4_board.tcl -notrace
