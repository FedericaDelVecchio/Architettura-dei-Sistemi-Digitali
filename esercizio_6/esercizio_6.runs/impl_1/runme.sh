...
HD_PWD='C:/VHDL/TESINA/esercizio_6/esercizio_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log CU_on_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source CU_on_board.tcl -notrace
