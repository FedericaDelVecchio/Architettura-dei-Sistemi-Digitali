...
HD_PWD='C:/VHDL/TESINA/esercizio_6/esercizio_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CU_on_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CU_on_board.tcl
