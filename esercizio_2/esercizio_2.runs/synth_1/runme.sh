...
HD_PWD='C:/VHDL/TESINA/esercizio_2/esercizio_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log S_board.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source S_board.tcl
