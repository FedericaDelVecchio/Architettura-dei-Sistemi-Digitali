...
HD_PWD='C:/VHDL/TESINA/esercizio_2/esercizio_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log S_board.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source S_board.tcl -notrace
